...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_get:
        ...
        if not TEST_FOR_GET_METHOD_RESPONSE_BODY:
            ...
            print(
                FAIL_COLOR +
                "Your test case for GET() does not\
                     seem to be testing the CONTENTS \
                         of the response.\n")
    ...
    if not test_functions_for_post:
        ...
        if len(test_functions_for_post) == 1:
            ...
            print(FAIL_COLOR + "Please make sure you have\
        ...
        if len(
            ...
            print(
                FAIL_COLOR +
                "You do not seem to have TWO separate test\
    ...
    print(
        WARN_COLOR +
        "You should still check your work against the \
